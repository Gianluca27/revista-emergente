...
function ConfirmDialog({ title, onConfirm, onCancel }) {
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-crema/80 backdrop-blur-sm"
    >
      <motion.div
      ...
      >
        ...
        <div className="flex gap-3">
          <button
            onClick={onConfirm}
            className="px-4 py-2 bg-rojo font-ui text-[10px] uppercase tracking-[0.25em] text-crema hover:bg-rojo-osc transition-colors"
          >
            Eliminar
          </button>
          <button
    ...
    <div className="px-6 py-8 max-w-6xl">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <Link
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-rojo font-ui text-[11px] uppercase tracking-[0.25em] text-crema hover:bg-rojo-osc transition-colors duration-150"
        >
          + Nueva
        </Link>
      </div>
            ...
            {pubs.map((pub, i) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="font-ui text-[12px] text-negro leading-tight truncate">
                    {pub.title}
                  </p>
                  {pub.subtitle && (
